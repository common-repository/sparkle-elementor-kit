...
<div class="swiper-slide elementor-repeater-item-<?php echo esc_attr($testimonial['_id']); ?>">
    <div <?php $this->print_render_attribute_string('testimonial'); ?> style="background-image: url('<?php echo esc_url($testimonial['client_image']['url']); ?>');">

        <div class="ese-full-image">
