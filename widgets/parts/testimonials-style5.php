...
<?php $this->add_render_attribute('testimonial', 'class', 'ese-style5'); ?>
    ...
    <div <?php $this->print_render_attribute_string('testimonial'); ?>>
        ...
        <div class="ese-left-right">
            ...
            <?php if (!empty($testimonial['client_image']['url'])): ?>
                <div class="ese-right">
                    <img src="<?php echo esc_url($testimonial['client_image']['url']); ?>" alt="right image" class="ese-image">
                </div>
            <?php endif; ?>
        </div>
